...
function Idhm(props) {
    return (
        <div className="idhm">
            <div className="idhm__principal" role="textbox" aria-label={`Índice de Desenvolvimento Humano Municipal 
                ${props.idhm === 0 ? "Sem dado" : props.idhm.toLocaleString("pt-BR")}`}>
                <h3>Índice de Desenvolvimento Humano Municipal <sup>[IDHM]</sup></h3>
